...
The [file](lib/plugins/file.go) plugin is the simplest so I'd copy that and add your plugin's new function [here](https://github.com/RyanJarv/liquidswards/blob/85b02d1fa0b0ade117a791ed1f0fb156646ac811/main.go#L57).

The Plugin should return true or false and a reason from the [Enabled](https://github.com/RyanJarv/liquidswards/blob/693a712c0f22d194b245787ab347fecd6b09570e/lib/plugins/file.go#L33) method to indicate if it is enabled or not. If the Plugin is disabled, other methods won't be called.

Most work should be placed in the [Run](https://github.com/RyanJarv/liquidswards/blob/693a712c0f22d194b245787ab347fecd6b09570e/lib/plugins/file.go#L49) method, however the Run method will block execution so if you have a lot of work to do put it in goroutine and implement the [Waitable](https://github.com/RyanJarv/liquidswards/blob/693a712c0f22d194b245787ab347fecd6b09570e/lib/types/types.go#L16) interface. The program won't exit until all the Wait method returns for all enabled plugins. Plugin specific arguments can go at the [top of the plugin](https://github.com/RyanJarv/liquidswards/blob/693a712c0f22d194b245787ab347fecd6b09570e/lib/plugins/file.go#L15).

Adding to, or acting on discovered roles is fairly straightforward, each plugin get's the global args struct which has a [FoundRoles](https://github.com/RyanJarv/liquidswards/blob/85b02d1fa0b0ade117a791ed1f0fb156646ac811/lib/types/types.go#L22) field, you can either add discovered role's through [Add](https://github.com/RyanJarv/liquidswards/blob/85b02d1fa0b0ade117a791ed1f0fb156646ac811/lib/plugins/file.go#L63) or iterate discovered role's using [Walk](https://github.com/RyanJarv/liquidswards/blob/85b02d1fa0b0ade117a791ed1f0fb156646ac811/lib/plugins/assume.go#L50). Any function passed to FoundRoles.Walk will recieve all previous and future discovered roles.
